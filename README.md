I designed a simple website using node.js as backend env, mongo db as a database that takes a get request from the client and send back the student data
